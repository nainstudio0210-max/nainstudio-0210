...
이메일, 전화, 문자, 인스타그램 DM, 카카오톡 채널 등 편하신 방법으로 언제든지 연락 주세요. 친절하고 자세하게 답변드리겠습니다.
                ...
                {/* ★ 요청하신 SNS 아이콘 3개 추가 부분입니다. ★ */}
                <div className="flex items-center gap-6 pt-4">
                  <a href="https://www.instagram.com/nainstudio0210/" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="Instagram">
                    <Instagram className="w-6 h-6 md:w-7 md:h-7" />
                  </a>
                  <a href="https://www.youtube.com/@Nainstudio-v5x" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="YouTube">
                    <Youtube className="w-6 h-6 md:w-7 md:h-7" />
                  </a>
                  <a href="https://pf.kakao.com/_hPAlX" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="KakaoTalk">
